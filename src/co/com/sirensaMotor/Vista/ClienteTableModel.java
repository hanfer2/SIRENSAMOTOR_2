...
public class ClienteTableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2: return consultado.getTipoIdentificacion();
            case 3: return consultado.getIdentificacion();
            case 4: return consultado.getCelular();
            case 5: return consultado.getTelefono();
            case 6: return consultado.getDireccion();
            case 7: return consultado.getEmail();
            case 8: return consultado.getCiudad();
